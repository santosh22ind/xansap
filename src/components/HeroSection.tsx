        ...
        <div className="flex">
          {slides.map((slide, i) => (
            ...
            >
              ...
              <div className="max-w-7xl mx-auto px-6 lg:px-8 py-36 lg:py-48 relative z-10">
                <div className="max-w-3xl">
                  ...
                  {/* Headline */}
                  <h1
                    className="text-5xl lg:text-7xl font-normal text-[#0f2d5c] leading-tight mb-3"
                  ...
                  <motion.p
                    ...
                    className="text-lg text-[#4a6080] leading-relaxed mb-10 max-w-xl"
                  >
                    {slide.sub}
                  </motion.p>
